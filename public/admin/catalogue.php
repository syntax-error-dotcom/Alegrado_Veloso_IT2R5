...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0 text-gray-900">Catalog Manager</h1>

        <div class="d-flex gap-2">
            <!-- Add Book (Green) -->
            <button type="button" class="btn btn-success shadow-sm text-white mr-2" 
                    data-toggle="modal" data-target="#addBookModal">
                <i class="fas fa-plus fa-sm text-white-50"></i> Add Book
            </button>

            <!-- Update Book (Yellow) -->
            <button type="button" class="btn btn-warning shadow-sm text-white mr-2" 
                    data-toggle="modal" data-target="#updateBookModal">
                <i class="fas fa-edit fa-sm text-white-50"></i> Update Book
            </button>

            <!-- Delete Book (Red) -->
            <button type="button" class="btn btn-danger shadow-sm text-white mr-2" 
...
<div class="modal fade" id="addBookModal" tabindex="-1" role="dialog" aria-labelledby="addBookLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <form method="POST" action="../../app/controllers/adminBackend/booksController.php" enctype="multipart/form-data" style="margin:20px;">
